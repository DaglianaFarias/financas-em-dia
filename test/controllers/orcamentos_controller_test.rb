...
class OrcamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orcamento" do
    assert_difference("Orcamento.count") do
      post orcamentos_url, params: { orcamento: { categoria: @orcamento.categoria, descricao: @orcamento.descricao, status: @orcamento.status, unidade_familiar_id: @orcamento.unidade_familiar_id, valorEstimado: @orcamento.valorEstimado } }
    end
  ...
  test "should update orcamento" do
    patch orcamento_url(@orcamento), params: { orcamento: { categoria: @orcamento.categoria, descricao: @orcamento.descricao, status: @orcamento.status, unidade_familiar_id: @orcamento.unidade_familiar_id, valorEstimado: @orcamento.valorEstimado } }
