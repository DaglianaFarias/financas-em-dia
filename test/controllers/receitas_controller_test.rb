...
class ReceitasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receita" do
    assert_difference("Receita.count") do
      post receitas_url, params: { receita: { dataEncerramento: @receita.dataEncerramento, dataEntrada: @receita.dataEntrada, descricao: @receita.descricao, usuario_id: @receita.usuario_id, valor: @receita.valor } }
    end
  ...
  test "should update receita" do
    patch receita_url(@receita), params: { receita: { dataEncerramento: @receita.dataEncerramento, dataEntrada: @receita.dataEntrada, descricao: @receita.descricao, usuario_id: @receita.usuario_id, valor: @receita.valor } }
